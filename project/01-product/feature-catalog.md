...
| Frontend i18n | Translation-ready UI strings and locale support through Intlayer | Reduces future internationalization cost | MVP | Frontend shell, TanStack Router | Use `prefix-no-default`, English as the default locale, cookie + localStorage persistence, and proxy-backed locale detection; backend code remains English-only |
